...
u4 = User.create!(role:"pharmacy", name: "Pharmacie d'Alsace et Lorraine", email:"pharmacy4@example.com", address:"132 Cours d'Alsace-Lorraine33000 Bordeaux", password:"password")
